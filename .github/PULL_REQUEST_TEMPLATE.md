...
**Confirm the following by checking the boxes [x]:**
- [ ] I have formatted the PR title as "Add <Flatpak ID>" (e.g., Add site.ikhlasulov.openrpm).
- [ ] I have tested this Flatpak locally.
